...
public class FriendshipService {
  ...
  public boolean deleteFriendship(String userEmail, String targetEmail) {
    Optional<FriendshipStatus> friendship = friendshipStatusRepository.findBySenderAndReceiverEmail(
    ...
    Optional<FriendshipStatus> reverseFriendship = friendshipStatusRepository.findBySenderAndReceiverEmail(
  ...
  public List<FriendshipStatusDTO> getPendingRequests(String userEmail) {
    return friendshipStatusRepository.findPendingRequestsBySender(userEmail,
  ...
  public List<FriendshipStatusDTO> getReceivedRequests(String userEmail) {
    return friendshipStatusRepository.findPendingRequestsByReceiver(userEmail,
            FriendshipStatusEnum.PENDING)
        .stream()
        .map(this::convertToDTO)
        .collect(Collectors.toList());
